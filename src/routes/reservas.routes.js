...
import { deleteReserva, getMisReservas, getReservas, postReserva } from '../controllers/reservas.controller.js';
import { authorizeRoles, verifyToken } from '../middleware/auth.middleware.js';

const router = Router();

router.get('/mis-reservas', verifyToken, authorizeRoles('Huesped'), getMisReservas);
